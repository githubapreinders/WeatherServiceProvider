...
public class WeatherDatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String CREATE_TABLE_WEATHER_DATA = "CREATE TABLE "
        ...
        + WeatherContract.WeatherConditionEntry.COLUMN_DESCRIPTION + " TEXT, "
        + WeatherContract.WeatherDataEntry.COLUMN_HUMIDITY + " REAL, "
        + WeatherContract.WeatherDataEntry.COLUMN_PRESSURE + " REAL, "
        + WeatherContract.WeatherDataEntry.COLUMN_LONGITUDE + " REAL, "
        + WeatherContract.WeatherDataEntry.COLUMN_LATTITUDE + " REAL, "
        ...
        + WeatherContract.WeatherDataEntry.COLUMN_MAINICON + " TEXT, "        
        + WeatherContract.WeatherDataEntry.COLUMN_ICON1 + " TEXT, "
        + WeatherContract.WeatherDataEntry.COLUMN_ICON2 + " TEXT, "
        + WeatherContract.WeatherDataEntry.COLUMN_ICON3 + " TEXT, "
        + WeatherContract.WeatherDataEntry.COLUMN_ICON4 + " TEXT, "        
        + WeatherContract.WeatherDataEntry.COLUMN_ICON5 + " TEXT, "        
        + WeatherContract.WeatherDataEntry.COLUMN_SUNRISESTRING + " TEXT, "        
        + WeatherContract.WeatherDataEntry.COLUMN_SUNSETSTRING + " TEXT, "        
        + WeatherContract.WeatherDataEntry.COLUMN_DATESTRING + " TEXT, "     
        + WeatherContract.WeatherDataEntry.COLUMN_GMTOFFSET + " REAL DEFAULT 0.0, "        
        + WeatherContract.WeatherDataEntry.COLUMN_CITYID + " INTEGER, "        
